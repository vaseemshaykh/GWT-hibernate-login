...
// */
//public class Sample_GWT_project_one implements EntryPoint {
//	/**
...
public class Sample_GWT_project_one implements EntryPoint {
	private final GreetingServiceAsync greeting = GWT.create(GreetingService.class);
	...
	public void onModuleLoad() {
		...
		verticalPanel.add(new Label("Email: "));
		verticalPanel.add(email);
		...
		signUpButton.addClickHandler(new ClickHandler() {
			...
			public void signup() {
				...
				String emailParam = email.getText();
				String passwordParam = password.getText();

				greeting.singUp(usernameParam, emailParam, passwordParam, new AsyncCallback<String>() {
					@Override
					public void onSuccess(String result) {
						if (result.equals("success")) {
							message.setText("Sign Up is Succesfull");

						} else {
							message.setText("Sign Up Failed please give proper inputs");
						}
		...
		loginButton.addClickHandler(new ClickHandler() {
			...
			public void login() {
				...
				greeting.login(emailParam, passwordParam, new AsyncCallback<String>() {
...
//							Window.Location.assign("Dashboard.html");
							...
							message.setText("login failed. Please correct email and password");
							loginButton.setEnabled(true);
						}
